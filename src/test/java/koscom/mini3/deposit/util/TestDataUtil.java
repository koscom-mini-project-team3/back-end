    ...
    public static List<Deposit> createMockDeposits() {
        return List.of(
                new Deposit(1L, "한국은행", "정기예금A", 6, 24, "인터넷, 영업점", "개인, 법인", "급여 이체 시 우대",
                        ...
                        new BigDecimal("3.00"), new BigDecimal("3.50"), new BigDecimal("4.00"),"어쩌구"),
                ...
                new Deposit(2L, "우리은행", "정기예금B", 12, 36, "영업점", "개인", "장기 가입 시 우대",
                        ...
                        new BigDecimal("2.50"), new BigDecimal("3.00"), new BigDecimal("3.80"),"어쩌구"),
                ...
                new Deposit(3L, "신한은행", "정기예금C", 24, 48, "모바일 앱", "개인, 법인", "자동이체 시 우대",
                        ...
                        new BigDecimal("3.80"), new BigDecimal("4.20"), new BigDecimal("4.80"),"어쩌구")
        );
    }
}
